Для тестов выбран один из крупнейших онлайн машазинов страны в которой я проживаю. Таное задание я буду добавлять в свое резюме, по-этому выбор пал именно так.
